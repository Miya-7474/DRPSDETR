...
def parse_args():
    ...
    # dataset parameters
    parser.add_argument("--coco-img", type=str, default="/home/csm/CSM/coco/val2017/")
    parser.add_argument("--coco-ann", type=str, default="/home/csm/CSM/coco/annotations/instances_val2017.json")
    parser.add_argument("--model-ann", type=str, default=None)
...
def visualize_datasets():
    ...
    if args.show_dir:
        ...
        if args.model_ann is not None:
            coco_dt = loadRes(COCO(args.coco_ann), args.model_ann)
