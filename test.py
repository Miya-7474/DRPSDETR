...
def parse_args():
    ...
    # dataset parameters
    parser.add_argument("--coco-path", type=str, default="/home/csm/CSM/coco/")
    parser.add_argument("--subset", type=str, default="val")
    parser.add_argument("--workers", type=int, default=2)

    # choose model to inference on dataset or result_file
    parser.add_argument("--model-config", type=str, default="/home/csm/CSM/DRPS-DETR/configs/salience_detr/drps_detr_resnet50.py")
    parser.add_argument("--checkpoint", type=str, default="/home/csm/CSM/DRPS-DETR/checkpoints/DRPS_DETR_resnet50_12ep_best_ap.pth")
